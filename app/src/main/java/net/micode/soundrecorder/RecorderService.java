...
public class RecorderService extends Service implements MediaRecorder.OnErrorListener {
    ...
    private void showRecordingNotification() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            Notification.Builder notificationBuilder = new Notification.Builder(getApplicationContext(), "id");
            notificationBuilder.setContentTitle(getString(R.string.app_name))                        //标题
                    .setContentText(getString(R.string.notification_recording))      //内容
                    .setTicker(getString(R.string.notification_recording))             //收到信息后状态栏显示的文字信息
    ...
    private void showLowStorageNotification(int minutes) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            Notification.Builder notificationBuilder = new Notification.Builder(getApplicationContext(), "id");
            notificationBuilder.setContentTitle(getString(R.string.app_name))                        //标题
                    .setContentText(getString(R.string.notification_warning, minutes))      //内容
                    .setTicker(getString(R.string.notification_warning, minutes))             //收到信息后状态栏显示的文字信息
                    .setWhen(System.currentTimeMillis())           //设置通知时间
                    .setDefaults(Notification.DEFAULT_LIGHTS | Notification.DEFAULT_VIBRATE | Notification.DEFAULT_SOUND)    //设置默认的三色灯与振动器
                    .setAutoCancel(true)                           //设置点击后取消Notification
                    .setContentIntent(pendingIntent);                        //设置PendingIntent
    ...
    private void showStoppedNotification() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            Notification.Builder notificationBuilder = new Notification.Builder(getApplicationContext(), "id");
            notificationBuilder.setContentTitle(getString(R.string.app_name))                        //标题
                    .setContentText(getString(R.string.notification_stopped))      //内容
                    .setTicker(getString(R.string.notification_stopped))             //收到信息后状态栏显示的文字信息
                    .setWhen(System.currentTimeMillis())           //设置通知时间
                    .setDefaults(Notification.DEFAULT_LIGHTS | Notification.DEFAULT_VIBRATE | Notification.DEFAULT_SOUND)    //设置默认的三色灯与振动器
                    .setAutoCancel(true)                           //设置点击后取消Notification
                    .setContentIntent(pendingIntent);                        //设置PendingIntent
